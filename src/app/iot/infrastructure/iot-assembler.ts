...
@Injectable({ providedIn: 'root' })
export class IotSnapshotAssembler implements BaseAssembler<IotSnapshot, IotSnapshotResource, IotSnapshotsResponse> {
  toEntityFromResource(resource: IotSnapshotResource): IotSnapshot {
    return new IotSnapshot(
  ...
  toResourceFromEntity(entity: IotSnapshot): IotSnapshotResource {
    return {
      id: Number(entity.id),
  ...
  toEntitiesFromResponse(response: IotSnapshotsResponse): IotSnapshot[] {
